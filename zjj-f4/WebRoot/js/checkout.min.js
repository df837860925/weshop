...
XIAOMI.checkOut = {
    ...
    init: function() {
        ...
        a.hideMoreAddr(),
        a.baoxian(),
        $("#J_addrListToggle").on("click", function() {
            return $(this).hasClass("on") ? (a.hideMoreAddr(),
            $(this).removeClass("on")) : ($("#checkoutAddrList").find("dl").show(),
            $(this).addClass("on")),
            !1
        }),
        $("#checkoutToPay").on("click", function(){
//        	location.href="/zjj-f4/MyJsp.jsp";
...
//			}
    ...
    checkShowCounpon: function() {
        ...
        0 !== checkoutConfig.showCouponBox && b === !1 && ($("#checkoutCouponBox").trigger("click"),
        $("#couponTabNav").children(".nav-item").eq(a).trigger("click"))
    },
    selectAddr: function() {
        var a = this
          , b = $("#checkoutAddrList")
    ...
    checkPayWay: function() {
        ...
        $("#checkoutPaymentList").on("click", "li", function() {
            var b = $(this).children('input[name="Checkout[pay_id]"]')
              , c = b.attr("data-type");
            return b.length <= 0 ? !1 : (a.selfService = "selfService" === c ? !0 : !1,
            void a.getPayment(b.val()))
        })
    },
    ...
    checkShipment: function() {
        ...
        0 === a ? this.disFree = !0 : (checkoutConfig.hasBigTv || checkoutConfig.hasAir || checkoutConfig.hasScales) && (checkoutConfig.postage = a),
    ...
    chooseInvoice: function() {
        $(".J_optionInvoice").children(".item").on("click", function() {
            ...
            $(".J_invoiceType").children("li").eq(1).trigger("click")) : a === checkoutConfig.invoice.electronic ? ($("#checkoutInvoiceDetail").hide(),
            $("#checkoutInvoiceElectronic").fadeIn(),
            $(".invoiceType").prop("checked", !1),
            $("#electronicPersonal").prop("checked", !0)) : ($("#checkoutInvoiceDetail").hide(),
            $("#checkoutInvoiceElectronic").hide(),
            $(".invoiceType").prop("checked", !1),
        ...
        $(".J_invoiceType").children("li").on("click", function() {
            ...
            a === checkoutConfig.invoice.company ? $("#CheckoutInvoiceTitle").show() : $("#CheckoutInvoiceTitle").hide().children("input").val(""),
            $(this).addClass("selected").siblings().removeClass("selected")
        })
    },
    checkInvoice: function() {
        var a = $("#CheckoutInvoiceTitle").children("input").val();
        return 0 === a.length ? ($("#CheckoutInvoiceTitle").children("input").focus().siblings(".J_tipMsg").html("单位名称不能为空").show(),
        !1) : a.length > 49 ? ($("#CheckoutInvoiceTitle").children("input").focus().siblings(".J_tipMsg").html("单位名称必须少于50个字").show(),
        !1) : ($("#CheckoutInvoiceTitle").children(".J_tipMsg").html("").hide(),
        !0)
    },
    useCoupon: function() {
        var a = this;
        $("#checkoutCouponBox").off().on("click", function() {
            ...
            b === !1 ? ($("#couponBox").fadeIn(100),
            a.chooseCoupon(),
            a.checkCoupon()) : ($("#couponBox").hide(),
            $("#couponType").val(""),
            $("#couponValue").val(""),
    ...
    chooseCoupon: function() {
        $("#couponTabNav").children(".nav-item").off().on("click", function() {
            var a = $(this).index();
            if ($(this).addClass("current").siblings().removeClass("current"),
            $("#couponTabCon").children(".con-item").eq(a).show().siblings().hide(),
            $(this).hasClass("couponList")) {
    ...
    checkCoupon: function() {
        ...
        $("#checkCouponBtn").off().on("click", function() {
            var b = $.trim($("#couponCode").val())
              , c = /^\d{16,}$/;
            return c.test(b) ? (a.getCouponInfo("yes", b),
            a.setMsg($("#checkCouponTip"))) : a.setMsg($("#checkCouponTip"), "优惠券码不正确"),
            !1
        }),
    ...
    getCouponInfo: function(a, b) {
        ...
        $.ajax({
            ...
            success: function(d) {
                ...
                -1 === d.code ? c.setMsg(e, d.message) : 1 === d.code && ($("#couponType").val(a),
                $("#couponValue").val(b),
                c.couponResult.t = a,
                c.couponResult.v = b,
                c.setMsg(e),
                c.dealWithCouponInfo(d.message),
                $("#checkoutCouponBox").addClass("selected").children("input").prop("checked", !0))
            }
        })
    },
    ...
    addBuy: function() {
        ...
        $(".J_addBuy").on("click", function() {
            ...
            var b = $(this).children("input")
              ...
              , f = (parseFloat(b.attr("data-price")),
            b.attr("data-isbatch"))
              , g = b.attr("data-actid");
            if (c !== !0) {
                if ("true" === f)
                    return a.chooseGoods(g),
                    !1;
                a.addCart(d, g)
            } else
                a.delProduct(e);
    ...
    addCart: function(a, b) {
        ...
        XIAOMI.app.addShopCart(a, function(a) {
            1 === a.code ? c.getProList() : (alert(a.message),
            $("#Gift" + b).attr("checked", !1).parent().removeClass("selected"))
        })
    },
    ...
    resetProList: function(a) {
        ...
        b.useCoupon(),
        ("yes" === c || "no" === c) && ($("#useCoupon").prop("checked", !0),
        $("#checkoutCouponBox").addClass("selected"),
        $("#couponBox").hide(),
        b.setCouponResult()),
        b.addBuy(),
        b.baoxian(),
    ...
    countTotalPrice: function() {
        ...
        checkoutConfig.hasBigTv || checkoutConfig.hasAir || checkoutConfig.hasScales || (this.disFree = a < checkoutConfig.bcPrice ? !1 : !0),
    ...
    baoxian: function() {
        ...
        $(".J_buyBaoxian").on("click", function() {
            ...
            f = $(this).find("input").attr("data-agreementurl"),
            $(".J_toBuyBaoxian").html("确认并购买服务" + e + "份"),
            $(".J_baoxianMore").attr("href", f),
            c ? (g.delProduct(d),
            $(this).removeClass("selected").find("input").prop("checked", !1),
            $(".J_baoxian_agree").find(".icon-checkbox").removeClass("icon-checkbox-checked"),
            !1) : void $("#baoxian").modal({
                backdrop: "static",
                show: !0
            }).on("hide.bs.modal", function() {
                b = !1,
        ...
        $(".J_toBuyBaoxian").off().on("click", function() {
            b === !0 ? (XIAOMI.app.addShopCart(a, function(a) {
                1 === a.code ? (g.getProList(),
                $(".J_buyBaoxian").addClass("selected").find("input").prop("checked", !0)) : alert(a.message)
            }),
...
XIAOMI.checkOut.newAddr = {
    ...
    init: function() {
        var a = this;
        a.getRegionsData(1, "Provinces"),
        $("#J_useNewAddr").on("click", function() {
            var b = $(this).attr("data-state");
            return $(this).attr("data-url") ? (location.href = $(this).attr("data-url"),
            !1) : ("off" === b ? (XIAOMI.app.placeholder($("#J_editAddrBox").find("input,textarea")),
            a.Show($(this)),
        ...
        $("#Provinces").change(function() {
            var b = $(this).val();
            "0" !== b ? (a.getRegionsData(b, "Citys"),
            a.newProvince = $(this).find("option:selected").html()) : (a.newProvince = null,
            a.newCity = null,
            a.newCounty = null),
        ...
        $("#Citys").change(function() {
            var b = $(this).val();
            "0" !== b ? (a.getRegionsData(b, "Countys"),
            a.newCity = $(this).find("option:selected").html()) : (a.newCity = null,
            a.newCounty = null)
        }),
        $("#Countys").change(function() {
            var b = $(this).val();
            "0" !== b ? (a.newCounty = $(this).find("option:selected").html(),
            a.newZipcode = $(this).find("option:selected").attr("zipcode"),
            $("#zipcodeTip").html("邮编为：" + a.newZipcode)) : (a.newCounty = null,
            a.newZipcode = null,
            $("#zipcodeTip").html(""))
        }),
        a.toEdit()
    ...
    validation: function(a) {
        ...
        !(b.strLen(t) >= 4))
            return c.focus(),
            b.setMsg(c, "收货人姓名 太短 (最小值为 2 个中文字)"),
            !1;
        if (!q.test(t))
            return c.focus(),
            b.setMsg(c, "收货人姓名不正确（只能是英文、汉字）"),
            !1;
        b.setMsg(c, ""),
        r.consignee = t,
        v = !0;
        var w = $.trim(i.val())
          , x = !1;
        if (a && w && w !== i.attr("placeholder") ? a = !1 : !a && w && w === i.attr("placeholder") ? i.attr("placeholder", "") : a || w || i.attr("placeholder", "输入11位手机号"),
        !a && w !== i.attr("placeholder") && !m.test(w))
            return i.focus(),
            b.setMsg(i, "请填写11位手机号"),
            !1;
        b.setMsg(i, ""),
        r.tel = w,
        r.telPlaceholder = i.attr("placeholder"),
        x = !0;
        var y = d.val()
          , z = e.val()
          , A = f.val()
          , B = !1;
        if (!(k.test(y) && k.test(z) && k.test(A)))
            return b.setMsg(d, "收货地址不正确"),
            !1;
        b.setMsg(d, ""),
        r.province = y,
        r.city = z,
        r.county = A,
        r.provinceName = b.newProvince,
        r.cityName = b.newCity,
        r.countyName = b.newCounty,
        B = !0;
        var C = $.trim(g.val()).replace(/</g, "").replace(/>/g, "").replace(/\//g, "").replace(/\\/g, "")
          , D = g.attr("placeholder")
          , E = !1;
        if (C === D && (C = ""),
        !(C.length >= 5 && C.length <= 32))
            return g.focus(),
            b.setMsg(g, "详细地址长度不对，最小为 5 个字，最大32个字"),
            !1;
        if (n.test(C) || o.test(C) || p.test(C))
            return g.focus(),
            b.setMsg(g, "详细地址不正确"),
            !1;
        b.setMsg(g, ""),
        ...
        v && B && E && G && x && J)
            if ("1" === s) {
                ...
                "true" === K && $("#checkoutAddrList").find(".selected").remove(),
                r.tel || (r.tel = r.telPlaceholder),
                b.createAddr(r),
                b.Close(),
                b.resetData()
            } else
    ...
    toEdit: function() {
        ...
        $(".J_editAddr").on("click", function() {
            if ($(this).attr("data-url"))
                return location.href = XIAOMI.GLOBAL_CONFIG.orderSite + $(this).attr("data-url"),
                !1;
            var b = $(this).parent().parent()
              , c = (b.attr("data-isnew"),
            b.attr("data-consignee"))
            ...
            m && $("#Tag").val(m),
            $("#Zipcode").val(k),
            $("#Telephone").attr("placeholder", l).val(""),
            XIAOMI.app.placeholder("#Telephone"),
            $("#Provinces").find("option[value='" + d + "']").prop("selected", !0),
            a.getRegionsData(d, "Citys", f),
            a.getRegionsData(f, "Countys", h),
            ...
            a.newCounty = i,
            a.Show(b),
            $("#J_editAddrOk").attr("data-isEdit", "true"),
            XIAOMI.checkOut.setAddrState(),
            !1
        })
    },
    editAddr: function(a) {
        ...
        a.tel ? (b.attr("data-tel", a.tel),
        b.find(".itemTel").html(a.tel)) : b.find(".itemTel").html(a.telPlaceholder),
        b.attr("data-tag", a.tag),
        b.attr("data-isedit", "true"),
        b.find(".itemConsignee").html(a.consignee),
        b.find(".itemTag").length > 0 && a.tag ? b.find(".itemTag").html(a.tag) : a.tag ? b.find("dt").append('<span class="itemTag tag">' + a.tag + "</span>") : a.tag || b.find(".itemTag").remove(),
    ...
    saveAddr: function(a) {
        ...
        $.ajax({
            ...
            dataType: "json",
            success: function(c) {
                1 === c.code ? (b.editAddr(a),
                XIAOMI.checkOut.getPayment(a.county),
                b.Close(),
                b.resetData()) : alert(c.msg)
            }
        })
    },
    strLen: function(a) {
    ...
    resetData: function() {
        $("#Consignee").val(""),
        $("#Street").val(""),
        $("#Telephone").val("").attr("placeholder", "输入11位手机号"),
        $("#Zipcode").val(""),
        $("#Tag").val(""),
        ...
        $(".tipMsg").html("").hide(),
        $("#telModifyTip").hide(),
        $("#J_editAddrOk").attr("data-isEdit", "false")
    },
    getRegionsData: function(parent, target, sId) {
        ...
        if (checkoutConfig.addressMatchVarName && (_data = eval(checkoutConfig.addressMatchVarName)),
        _data) {
                ...
                if (1 === parent)
                    ...
                    for (var k = 0; k < _data[i].child.length; k += 1)
                        if (_data[i].id === parent)
                            ...
                            for (var j = 0; j < _data[i].child[k].child.length; j += 1)
                                _data[i].child[k].id === parent && regionData.regions.push({
